...
//   const [showMore, setShowMore] = useState(false)
//   const [isFavorite, setIsFavorite] = useState(false)
//   const [updatedReviews, setUpdatedReviews] = useState(reviews) // Для обновленных отзывов
...
//     // Добавление случайных аватарок для рецензентов
//     const reviewerAvatars = [
//       'https://ftp.goit.study/img/avatars/reviewer1.jpg',
//       'https://ftp.goit.study/img/avatars/reviewer2.jpg',
//       'https://ftp.goit.study/img/avatars/reviewer3.jpg',
//       'https://ftp.goit.study/img/avatars/reviewer4.jpg',
//       'https://ftp.goit.study/img/avatars/reviewer5.jpg',
//       'https://ftp.goit.study/img/avatars/reviewer6.jpg',
//     ]

//     const updatedReviews = reviews.map((review) => {
//       const randomAvatar =
//         reviewerAvatars[Math.floor(Math.random() * reviewerAvatars.length)]
//       return { ...review, reviewer_avatar_url: randomAvatar }
//     })
...
//                 name_review={name} // чи яке поле ви хочете використовувати
//                 rating={rating}
//                 reviews={updatedReviews} // передаємо обновленные отзывы с аватарками
//                 experience={experience}
//                 levels={levels}
//               />
//             )}
